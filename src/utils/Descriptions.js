...
const strings = new LocalizedStrings({
    en: {
        home: {
            ...
            newsFeed: 'Subscribe to our Newsletter!',
        },
        header: {
            events: 'Events',
            community: 'Community',
    ...
    hu: {
        home: {
            ...
            description: `A rendező gárda kb. 11-15 főből áll, 
                ...
                színes és igényes tánctanulási és szórakozási lehetőséget nyújtani, 
                és ezzel minél több emberhez eljuttatni a tánc üzenetét.`,
            joinus: 'Csatlakozom a rendezőkhöz',
            newsFeed: 'Feliratkozom a hírlevélre',
        },
        header: {
            events: 'Események',
            community: 'Közösség',
        ...
        path: {
            title: 'Megközelítés: ',
            desc: '4-es villamos › Budafoki út; 33, 86, 212-es busz › Október huszonharmadika utca (1117 Budapest, Irinyi József utca 42.)',
        },
        wayIn: {
            title: 'Bejutás: ',
            desc: 'A lépcsőn fel, majd a porta mellett elhaladva bal oldalt (nem a forgóvillákon keresztül).',
        },
        newsfeed: {
